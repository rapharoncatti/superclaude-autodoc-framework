...
echo ""
echo "2. Initialize the behavioral framework:"
echo "   In Claude, type: ${YELLOW}/init${NC}"
echo "   Or run: ${YELLOW}node .superclaude/init-behavioral-framework.js${NC}"
echo ""
echo "3. The framework will teach Claude:"
echo "   • How to think with 7 different personas"
echo "   • When to switch based on context"
echo "   • Which /sc: commands to use"
echo "   • Complete workflow patterns"
